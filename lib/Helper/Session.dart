...
Future<void> saveUserDetail({
  ...
  waitList.add(prefs.setString(fromTime, Fromtime!));
  waitList.add(prefs.setString(toTime, Totime!));
  waitList.add(prefs.setString(fromTime1, Fromtime1!));
  waitList.add(prefs.setString(toTime1, Totime1!));
  waitList.add(prefs.setString(fromTime2, Fromtime2!));
  waitList.add(prefs.setString(toTime2, Totime2!));
