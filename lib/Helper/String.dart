...
final String BankCOde = "sellerbankcode";
final String bankNAme = "sellerbank_name";
...
final String fromTime1 = "from_time1";
...
const String accountNumber = 'selleracountnumber';
const String accountName = 'selleracountname';
const String bankCode = 'sellerbankcode';
const String bankName = 'sellerbank_name';
