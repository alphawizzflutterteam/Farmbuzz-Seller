...
const Color primary =Color(0xffF88112);
const Color secondary = Color(0xffFFFFFF);
const Color fontColor = Colors.black;
const Color grad1Color = Color(0xFFF88112);
const Color grad2Color = Color(0xFFF88112);
...
const Color darkColor = Color(0xffF2935D);
const Color darkColor2 = Color(0xffF2935D);
