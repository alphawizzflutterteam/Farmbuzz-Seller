  ...
  Future<void> updateProfile() async {
    try {
      var request = MultipartRequest(
          'POST',
          Uri.parse(
              'https://developmentalphawizz.com/farmbuz/seller/app/v1/api/update_photo'));
...
//========================= For Update Saller API  =============================
  ...
  Future<String> selectMedia(ImageSource source) async {
    ...
    var icon = await picker.pickImage(source: source);
    img = File(icon!.path);
    print(img?.path);
                      ...
                      child: TextField(
                        ...
                        onTap: () {
                          if (mstController.text.isNotEmpty) {
                            ...
                            Fluttertoast.showToast(
                                msg:
                                    "Please Select Start Time Before Selecting This");
                          }
                        },
                        cursorColor: Color(0xffFF00FF),
                  ...
                  Expanded(
                    child: Padding(
                      ...
                      child: TextField(
                        ...
                        onTap: () {
                          if (mstController.text.isNotEmpty &&
                              metController.text.isNotEmpty) {
                            _openTimePickerSheet(context, "est");
                          } else {
                            Fluttertoast.showToast(
                                msg:
                                    "Please Select Morning Time Slot Before Selecting This");
                          }
                        },
                        cursorColor: Color(0xffFF00FF),
                      ...
                      child: TextField(
                        ...
                        onTap: () {
                          if (mstController.text.isEmpty ||
                            ...
                            Fluttertoast.showToast(
                                msg:
                                    "Please Select Morning Time Slot & Evening Time Slot Before Selecting This");
                          } else {
